/**
 * /**
 * NoTryCatchModule  calls three types of JS errors
 * These errors have no  try catch, therefore,   these  are shown on the console
 *
 * DEPENDENCIES
 * JQUERY
 *
 ...
 * @constructor
 */
var NoTryCatchModule= function(idBtnVarNotDef, idBtnIsNotAFunc,idBtnUndefProperty,idShowMsj){
     ...
     * @private
     */
   var __setUp= function(idBtnVarNtoDef, idBtnIsNotAFunc,idBtnUndefProperty,idShowMsj){

       __defineActions(idBtnVarNotDef, idBtnIsNotAFunc,idBtnUndefProperty,idShowMsj);
   };
     ...
     * @private
     */
   var __defineActions= function(idBtnVarNotDef, idBtnIsNotAFunc,idBtnUndefProperty,idShowMsj){

       $("#"+idBtnVarNotDef).click(function(){
           __showMsj(idShowMsj,"Error: Variable is not defined ");
           __variableNotDefined();
       });
     ...
     * @private
     */
    var __variableNotDefined= function(){
     ...
     * @private
     */
    var __undefinedProperty= function(){
    ...
    __setUp(idBtnVarNotDef, idBtnIsNotAFunc,idBtnUndefProperty,idShowMsj);
};